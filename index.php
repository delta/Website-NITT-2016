...
<!DOCTYPE html>
<html lang="en">
    <!--manifest="<?php echo $TEMPLATEBROWSERPATH; ?>/manifest.appcache"> -->
    <head>
        <meta charset="utf-8">
        ...
        <!-- Google web fonts -->
        <link href="<?php echo $TEMPLATEBROWSERPATH; ?>/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
        <!-- font-awesome -->
        <link href="<?php echo $TEMPLATEBROWSERPATH; ?>/css/dropdown-menu.css" rel="stylesheet" type="text/css">
        <!-- dropdown-menu -->
        <link href="<?php echo $TEMPLATEBROWSERPATH; ?>/css/bootstrap.min.css" rel="stylesheet" type="text/css">
        <!-- Bootstrap -->
        <link href="<?php echo $TEMPLATEBROWSERPATH; ?>/css/jquery.fancybox.css" rel="stylesheet" type="text/css">
        <!-- Fancybox -->
        <link href="<?php echo $TEMPLATEBROWSERPATH; ?>/css/style.css" rel="stylesheet" type="text/css">
        <!-- theme styles -->
    ...
    <body role="document" onload="<?php echo $STARTSCRIPTS; ?>">
        <nav class="navbar navbar-default myrow0navbar">
            <!-- functional navig -->
        ...
        <!-- device test end -->
        <div id="k-head" class="container-fluid" style="margin:0px;">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <!-- site logo end -->
                <nav id="k-menu affix" class="k-main-navig" style="background-color: rgb(255, 255, 255);">
                    <!-- main navig -->
